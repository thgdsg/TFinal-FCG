...
bool move_w = false, move_a = false, move_s = false, move_d = false;
bool press_space = false;
glm::vec4 camera_position_c = glm::vec4(0.0f, 1.0f, -5.0f, 1.0f); // Ponto "c", centro da câmera inicial
...
int main(int argc, char* argv[])
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(800, 600, "INF01047 - 00344125 - Leonardo Gonzatti Heisler", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec4 camera_view_vector = glm::vec4(vx, vy, vz, 0.0f);//olhar 
        ...
        glm::mat4 view = Matrix_Camera_View(&camera_position_c, &camera_velocity,camera_view_vector, camera_up_vector, move_w, move_a, move_s, move_d,press_space,gravity,ground_level,jump_force, delta_t);
